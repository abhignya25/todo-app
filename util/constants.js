...
exports.messages = {
    ...
    SUBTASK_DESCRIPTION_LENGTH: 'Subtask description must be between 0 and 500 characters',
    ...
    TASK_ERROR: 'Error creating task',
    TASK_TITLE_TYPE: 'Task title must be a string',
    TASK_TITLE_LENGTH: 'Task title must be between 3 and 100 characters',
    TASK_DESCRIPTION_TYPE: 'Task description must be a string',
    TASK_DESCRIPTION_LENGTH: 'Task description must be between 0 and 500 characters',
